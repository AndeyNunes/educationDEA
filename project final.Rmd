...
###Recommendations for each country. We have lambda values for every country, we can give recommendations based on how  can each country scale its spending to achieve similar output or better. This can also be tabulated. 
...
[6] J. Lamb, K.H Tee, Data envelopment analysis models of investment funds,  European Journal of Operational Research, Volume 216, Issue 3, 2012, Pages 687-696

[7]H. David. Sherman and Joe Zhu, Service Productivity Management: Improving Service Performance Using Data Envelopment Analysis (DEA), Springer Science, 2006, pages 49-89.
 
[8] Ji, Yong-bae and Lee, Choonjoo, (2010), Data envelopment analysis, Stata Journal, 10, issue 2, p. 267-280, https://EconPapers.repec.org/RePEc:tsj:stataj:v:10:y:2010:i:2:p:267-280.

[9]J.Ruiz, J.Segura, I.Sirvent, Benchmarking and target setting with expert preferences: An application to the evaluation of educational performance of Spanish universities,European Journal of Operational Research,Volume 242, issue 2, p. 594-605, https://EconPapers.repec.org/RePEc:eee:ejores:v:242:y:2015:i:2:p:594-605
