...
The paper aims to study the efficiency of the public expenditures on education of OECD (Organization for Economic Development) countries and it examines efficiency by looking at the relationship between inputs and outputs. DEA (Data Envelopement Analysis), which is a vastly used tool for measuring efficiency, has been conducted to measure the efficiency of the public expenditures on education by the countries. 
